...
export interface FileMapDelta<T = null | void> {
  readonly removed: Iterable<[CanonicalPath, T]>;
  readonly addedOrModified: Iterable<[CanonicalPath, T]>;
}
...
export interface FileMapPlugin<SerializableState extends void | V8Serializable = void | V8Serializable, PerFileData extends void | V8Serializable = void | V8Serializable> {
  ...
  onRemovedFile(relativeFilePath: string, pluginData: null | undefined | PerFileData): void;
  onNewOrModifiedFile(relativeFilePath: string, pluginData: null | undefined | PerFileData): void;
  getCacheKey(): string;
